...
public class LogoutandShut {
    Runtime runtime;
    String os; //The Server's Operating system
    private static LogoutandShut instance = new LogoutandShut();
    public static LogoutandShut getInstance(){return instance;}
    ...
    public LogoutandShut(){//Constructor
        try {
    ...
    public static void main(String[] arg){
        LogoutandShut LogoutandShut = new LogoutandShut();
        LogoutandShut.Logout("");
    }
}
